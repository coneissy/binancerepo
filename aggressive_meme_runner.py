"""Dynamic Top-20 meme dry-run profile.

The strategy continuously ranks the meme universe and monitors only the strongest
20 symbols. Entry still requires live volatility, volume/liquidity, momentum,
order-book, flow and cost confirmation.
"""
import os
