...
# No fixed bps floor: accept any genuinely positive net edge after modeled costs.
# This allows very small profitable opportunities (including ~$0.01), without capping larger profits.
...
def candidates():
    ...
    for s in syms:
        ...
        for direction,buy,sell,buyq,sellq in (("SPOT_BUY_FUT_SELL",ask_s,bid_f,aq_s,bq_f),("FUT_BUY_SPOT_SELL",ask_f,bid_s,aq_f,bq_s)):
            ...
            # Real-market eligibility: no artificial bps floor. Costs must still be covered.
            if depth<MIN_DEPTH or net<=0:continue
