...
<title>Binance 1m Alpha Engine</title>
<style>
...
<div class="section card"><div class="bar"><b>Top Ranked Meme Coins — 1m</b><span id="refresh" class="refresh">Auto refresh 3s</span></div><table><thead><tr><th>#</th><th>Symbol</th></tr></thead><tbody id="coins"></tbody></table></div>
<div class="section card"><div class="bar"><b>1m Engine Activity</b></div><div class="muted" id="activity">Loading...</div></div>
</div>
<script>
...
def main():
    ...
    print('Health/stats server for 1m alpha engine listening on :%d' % port, flush=True)
